...
const BidRequestTableRow = ({bidRequest, handleStatusChange}) => {
  const { title, deadline, price, category, status, email, _id } = bidRequest || {};
  return (
    <tr>
      ...
      <td className="px-4 py-4 text-sm whitespace-nowrap">
        <div className="flex items-center gap-x-6">
          {/* accept button */}
          <button disabled={status === 'In Progress' || status === 'Completed'} onClick={ () => handleStatusChange(_id, status, "In Progress")} className="disabled:cursor-not-allowed text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none">
            <svg
